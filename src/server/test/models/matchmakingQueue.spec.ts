...
const ratingValue1: number = 1500;
const ratingValue2: number = 1600;
const rating1: Rating = RatingFactory.create(ratingValue1);
const rating2: Rating = RatingFactory.create(ratingValue2);
