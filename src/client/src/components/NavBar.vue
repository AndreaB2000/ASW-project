  ...
  <MDBNavbar expand="lg" bg="transparent" container>
    ...
    <MDBCollapse v-model="toggler" id="navbarSupportedContent">
      <MDBNavbarNav class="mb-2 mb-lg-0">
        <MDBNavbarItem class="mx-2 my-1" style="cursor: pointer" @click="$router.push('/play')"
          ><MDBIcon icon="gamepad" class="fas"></MDBIcon> Play</MDBNavbarItem
        >
        <MDBNavbarItem class="mx-2 my-1" style="cursor: pointer" @click="$router.push('/tutorial')"
        ...
        <MDBNavbarItem style="cursor: pointer" class="d-block d-lg-none mx-2 my-1" @click="logout"
