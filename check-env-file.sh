...
ENV_FILE="./.env"
REQUIRED_VARS=("DB_PROTOCOL" "DB_APP_USERNAME" "DB_APP_PASSWORD" "DB_NAME" "DB_PORT" "DB_IP" "SERVER_INTERNAL_PORT" "SERVER_PORT" "SERVER_IP" "SERVER_PROTOCOL" "DB_ADMIN_USERNAME" "DB_ADMIN_PASSWORD" "CLIENT_IP")
